...
CONST_BASE_TELEMEDICINE_PROVIDERS_API_REQUEST_URL = (
    "https://cannaleo.de/api/v1/views/tele_med_configurator/"
)
...
CONST_DB_NOTIFICATION_EVENT_TYPES = {
    "PRODUCT_ADDED",
    "PRODUCT_REMOVED",
